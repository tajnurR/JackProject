...
//		Admissions
		try {
			String main = "";
			int LangSize = driver.findElements(By.xpath("//h3[normalize-space()='Bar Admissions']/following-sibling::h3[1]/preceding-sibling::p")).size();
...
////		Image 
		try {
			String img = driver.findElement(By.xpath("//div[@class='hero__image']/img")).getAttribute("src");
			sm.setImg(img);
		} catch (Exception e) {
			// TODO: handle exception
		}
