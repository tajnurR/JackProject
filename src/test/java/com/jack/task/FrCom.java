...
public class FrCom {
	...
	String filename = "E:\\Work Temp\\work\\Jack\\5(2)\\frcom\\input.xlsx";
	String sheetName = "Sheet1";
	
	String fileOut = "E:\\Work Temp\\work\\Jack\\5(2)\\frcom\\Row Scarped.xlsx";
...
//		driver.manage().deleteAllCookies();
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(@class,'bio-title')]/h2")));

	//	Name
		try {
			String name = driver.findElement(By.xpath("//div[contains(@class,'bio-title')]/h2")).getText();
...
//		//	Email
//		try {
//			String email = driver.findElement(By.xpath("//dl[@aria-label='Contact Information']/dd[normalize-space()='Email']/following-sibling::dt[1]/a")).getAttribute()
...
//		Bio
		try {
			...
			StringBuilder bio = new StringBuilder();
				bio.append(driver.findElement(By.xpath("//section[contains(@class,'bio-lead')]")).getAttribute("innerHTML"));
...
//		}
		...
		try {
			String main = "";
			int practiceSize = driver.findElements(By.xpath("(//span[normalize-space()='Services'])[2]/parent::h2/following-sibling::ul/li")).size();
			for (int i = 1; i < practiceSize+1; i++) {
				String practice = driver.findElement(By.xpath("(//span[normalize-space()='Services'])[2]/parent::h2/following-sibling::ul/li["+i+"]")).getText();
				if (i<=2) {
...
//		Admissions
		try {
			String main = "";
			int LangSize = driver.findElements(By.xpath("//span[normalize-space()='Admissions']/parent::h2/following-sibling::ul/li")).size();
			
			for (int i = 1; i < LangSize+1; i++) {
				String bar = driver.findElement(By.xpath("//span[normalize-space()='Admissions']/parent::h2/following-sibling::ul/li["+i+"]")).getAttribute("innerHTML");
...
//		Education
		try {
			...
			String main = "";
			int eduSize = driver.findElements(By.xpath("//span[normalize-space()='Education']/parent::h2/following-sibling::ul/li")).size();
			for (int i = 1; i < eduSize+1; i++) {
				String edu = driver.findElement(By.xpath("//span[normalize-space()='Education']/parent::h2/following-sibling::ul/li["+i+"]")).getText();
				if (i<=5) {
...
//		Language
		try {
			...
			String main = "";
			int eduSize = driver.findElements(By.xpath("//span[normalize-space()='Languages']/parent::h2/following-sibling::ul/li")).size();
			for (int i = 1; i < eduSize+1; i++) {
				String edu = driver.findElement(By.xpath("//span[normalize-space()='Languages']/parent::h2/following-sibling::ul/li["+i+"]")).getText();
					main+=";"+edu;
			}
...
//		CLERKSHIPS
		try {
			...
			String main = "";
			int eduSize = driver.findElements(By.xpath("//span[normalize-space()='Clerkships']/parent::h2/following-sibling::ul/li")).size();
			for (int i = 1; i < eduSize+1; i++) {
				String edu = driver.findElement(By.xpath("//span[normalize-space()='Clerkships']/parent::h2/following-sibling::ul/li["+i+"]")).getText();
					main+=";"+edu;
			}
