...
//	ChromeOptions opt;
	...
	String filename = "D:\\Fiverr Work\\Jack Project 4\\ARENTFOX SCHIFF LLP\\img.xlsx";
...
//		Image Dwonload save
		...
		OutputStream fos = new FileOutputStream("D:\\Fiverr Work\\Jack Project 4\\ARENTFOX SCHIFF LLP\\rimg\\"+id+".jpg");
		 int ch;
         while ((ch = is.read()) != -1) { 
                fos.write(ch);
...
//		Rename 
//		String rootPath = "D:\\Fiverr Work\\Jack Project 4\\Davis Wright Tremaine LLP\\img\\"+imgLink;
//		File f = new File(rootPath);
//		String getEx = FilenameUtils.getExtension(rootPath);
//		String storepaath = "D:\\Fiverr Work\\Jack Project 4\\Davis Wright Tremaine LLP\\rimg\\"+id+"."+getEx;
