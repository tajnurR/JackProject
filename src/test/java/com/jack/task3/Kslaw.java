...
public class Kslaw {
	...
	String filename = "D:\\Fiverr Work\\Jack Project 2\\King & Spalding LLP\\Links.xlsx";
...
//		//	Title
		try {
			String title = driver.findElement(By.xpath("//div[@class='name']/p")).getText();
			sm.setTitle(title);
		} catch (Exception e) {
...
//		//	Email
		try {
			String email = driver.findElement(By.xpath("//div[@class='contacts']/p/a[contains(@href,'mailto:')]")).getText();
			sm.setEmail(email);
		} catch (Exception e) {
...
//		//	Phone
		try {
			String phone = driver.findElement(By.xpath("(//div[@class='contacts']/p/a[contains(@href,'tel:')])[1]")).getText();
			sm.setPhone(phone);
		} catch (Exception e) {
...
////		Location
		try {
			String main = "";
			int locationSize = driver.findElements(By.xpath("//div[@class='contacts']/p/a[contains(@href,'offices')]")).size();
			for (int i = 1; i < locationSize+1; i++) {
				String location = driver.findElement(By.xpath("(//div[@class='contacts']/p/a[contains(@href,'offices')])["+i+"]")).getText();
				if (i<=1) {
...
////		Image 
		try {
			String img = driver.findElement(By.xpath("//div[@class='box headshot']")).getAttribute("style");
			sm.setImg(img);
		} catch (Exception e) {
			// TODO: handle exception
		}
	...
	public void saveList() throws Exception {
		...
		mapper.writeValue(new File("D:\\Fiverr Work\\Jack Project 2\\King & Spalding LLP\\row.json"), lists);
