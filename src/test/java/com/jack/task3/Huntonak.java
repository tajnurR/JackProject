...
public class Huntonak {
	...
	String filename = "D:\\Fiverr Work\\Jack Project 2\\Hunton Andrews Kurth LLP 8\\input.xlsx";
...
//		driver.manage().deleteAllCookies();
		...
		try {
			String main = "";
			int locations = driver.findElements(By.xpath("(//li[@class='type__body-copy'])")).size();
			for (int i = 1; i < locations+1; i++) {
				String location = driver.findElement(By.xpath("(//li[@class='type__body-copy'])["+i+"]")).getText();
...
//		Clerkships
	...
	public void saveList() throws Exception {
		...
		mapper.writeValue(new File("D:\\Fiverr Work\\Jack Project 2\\Hunton Andrews Kurth LLP 8\\row.json"), lists);
